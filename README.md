...
- `index.html` - public website page
- `styles.css` - responsive design system
- `CNAME` - custom domain value for GitHub Pages style hosting
- `robots.txt` - crawler rules
- `sitemap.xml` - sitemap for the homepage
- `_headers` - optional static host security headers
